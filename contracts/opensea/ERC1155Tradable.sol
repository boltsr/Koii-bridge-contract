...
import "../multi-token-standard/tokens/ERC1155/ERC1155.sol";
import "../multi-token-standard/tokens/ERC1155/ERC1155Metadata.sol";
import "../multi-token-standard/tokens/ERC1155/ERC1155MintBurn.sol";
import "./Strings.sol";
...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    function burnFrom(
        ...
        require(
            balances[_from][_id] > 0,
            "ERC1155Tradable#ownersOnly: ONLY_OWNERS_ALLOWED"
        );
        require(
            (msg.sender == _from) || isApprovedForAll(_from, msg.sender),
            "ERC1155Tradable#burnFrom: INVALID_OPERATOR"
        );
